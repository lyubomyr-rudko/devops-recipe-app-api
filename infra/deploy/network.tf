...
# Endpoiits to allow ECS toa ccess ECR, CloudWatch and Systems Manager

resource "aws_security_group" "endopoint_access" {
...
resource "aws_vpc_endpoint" "ecr" {
  ...
  security_group_ids = [aws_security_group.endopoint_access.id]
...
resource "aws_vpc_endpoint" "claoudwatch_logs" {
  vpc_id              = aws_vpc.main.id
